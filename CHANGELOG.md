...
* The public list and tag views now share a load-more controller for consistent loading, disabled, and end-of-results button state; the city view uses the same controller for its infinite-scroll sentinel and localized end-of-results state.
