...
* Standard public pages now use one cohesive, compact hero component with consistent width, restrained height, left-aligned content, blue gradients, typography, labels, calls to action, spacing, and explicit light/dark theme styling; campaign and guide pages retain their intentional visual identities.
