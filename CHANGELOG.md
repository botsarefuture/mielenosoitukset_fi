...
### Changed
* Demonstration suggestions now use the shared, responsive admin collection and review components with permission-scoped totals, deterministic server-side pagination, clear multi-select state, and a common confirmation modal; city and organization administrators no longer receive global suggestion rows or counts.
