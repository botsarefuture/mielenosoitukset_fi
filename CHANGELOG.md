...
### Fixed
* The recurring-demonstration collection now applies permission scope, search, approval filtering, stable server-side pagination, truthful result counts, and the same shared page-size/footer contract as the other admin collections instead of filtering only the current browser table.
