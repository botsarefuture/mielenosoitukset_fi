...
* The public demonstration page's report and choice dialogs now cap their height to the viewport with a pinned header/footer and an internally scrolling body, so neither modal clips above/below the screen on mobile or overflows horizontally; the two-choice cards are more compact on small screens and the report dialog buttons sit side by side.
