...
### Added
* Recurring-demonstration create and edit forms now show a live, permission-protected preview of the next occurrence dates from the same calculation used by the background worker, including the selected monthly day, end date, and excluded break dates, before any child demonstrations are generated.
