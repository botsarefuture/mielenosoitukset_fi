...
* `record_event()` in `mielenosoitukset_fi/utils/site_analytics.py` provides a thin, aggregate-only foundation for future named analytics events (search, CTA clicks, ...) sharing the same counters collection.
