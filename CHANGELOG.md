...
### Fixed
* The shared admin sidebar now identifies the authenticated user's real global, city, organization, translator, or restricted scope instead of telling every admin-shell user that they are in superuser mode.
