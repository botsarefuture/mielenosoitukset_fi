...
* Standard public pages now use one cohesive hero component with consistent width, left-aligned content, restrained blue gradients, typography, labels, calls to action, spacing, and explicit light/dark theme styling; campaign and guide pages retain their intentional visual identities.
