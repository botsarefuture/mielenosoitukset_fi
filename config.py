...
class Config:
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'c0dff75e4abffdc8ad0b391c58c2f3aee88f9e8d2481d8c0'
    MONGO_URI = os.environ.get('MONGO_URI') or 'mongodb://95.216.148.93:27017/mielenosoitukset'
    MAIL_SERVER = 'mail3.luova.club'
    MAIL_PORT = 587
    MAIL_USE_TLS = True
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME') or 'no-reply@mielenosoitukset.fi'  # Set in environment or config file
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD') or 'G7s!fE2bP@r8ZqL4'  # Set in environment or config file
    MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER') or 'no-reply@mielenosoitukset.fi'
