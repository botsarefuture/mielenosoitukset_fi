...
def organization_detail(org_id):
    ...
    return render_template('organization/organization_detail.html', organization=organization, is_member=is_member)
...
def edit_organization(org_id):
    ...
    return render_template('organization/edit_organization.html', organization=organization)
...
def create_demonstration():
    ...
    return render_template('demonstration/create_demonstration.html', organizations=organizations)
